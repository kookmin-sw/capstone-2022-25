...
import learning.kotlin.part2.holyseat.contentsList.BookmarkRVAdapter
import learning.kotlin.part2.holyseat.contentsList.ContentModel
import learning.kotlin.part2.holyseat.databinding.FragmentBookmarkBinding
...
//        getCategoryData()
        ...
        binding.genreTab.setOnClickListener {
            it.findNavController().navigate(R.id.action_bookmarkFragment_to_genreFragment)
        }
        binding.talkTab.setOnClickListener{
            it.findNavController().navigate(R.id.action_bookmarkFragment_to_talkFragment)
        }
        binding.siteTab.setOnClickListener{
            it.findNavController().navigate(R.id.action_bookmarkFragment_to_siteFragment)
        }
